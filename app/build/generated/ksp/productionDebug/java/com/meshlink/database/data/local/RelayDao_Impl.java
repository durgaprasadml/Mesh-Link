...
public final class RelayDao_Impl implements RelayDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfEnforceStorageCap;
  ...
  public RelayDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfRelayPacketEntity = new EntityInsertionAdapter<RelayPacketEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `relay_packets` (`packetId`,`senderId`,`targetId`,`payload`,`type`,`priority`,`broadcastType`,`timestamp`,`expiryTimestamp`,`ttl`,`hopCount`,`encrypted`,`transferId`,`chunkIndex`,`totalChunks`,`mimeType`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(7, entity.getBroadcastType());
        ...
        if (entity.getTransferId() == null) {
          ...
          statement.bindString(13, entity.getTransferId());
        }
        statement.bindLong(14, entity.getChunkIndex());
        statement.bindLong(15, entity.getTotalChunks());
    ...
    this.__preparedStmtOfEnforceStorageCap = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM relay_packets WHERE packetId IN (SELECT packetId FROM relay_packets ORDER BY timestamp DESC LIMIT -1 OFFSET ?)";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object enforceStorageCap(final int maxSize, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfEnforceStorageCap.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfEnforceStorageCap.release(_stmt);
        }
      }
    }, $completion);
  }
    ...
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<List<RelayPacketEntity>>() {
      ...
      public List<RelayPacketEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfBroadcastType = CursorUtil.getColumnIndexOrThrow(_cursor, "broadcastType");
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpBroadcastType;
            _tmpBroadcastType = _cursor.getString(_cursorIndexOfBroadcastType);
            ...
            _item = new RelayPacketEntity(_tmpPacketId,_tmpSenderId,_tmpTargetId,_tmpPayload,_tmpType,_tmpPriority,_tmpBroadcastType,_tmpTimestamp,_tmpExpiryTimestamp,_tmpTtl,_tmpHopCount,_tmpEncrypted,_tmpTransferId,_tmpChunkIndex,_tmpTotalChunks,_tmpMimeType);
            _result.add(_item);
          }
          return _result;
        } finally {
